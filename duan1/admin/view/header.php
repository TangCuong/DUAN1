    ...
    <div class="app-main">
            <nav class="sidebar bg-primary">
                <ul>
                    ...
                    <li>
                        <a href="index.php?pg=orders"><i class="fa-solid fa-cart-shopping ico-side"></i>Quản lí đơn hàng</a>
                    </li>
                    <li>
                        <a href="index.php?pg=categories"><i class="fa-solid fa-folder-open ico-side"></i>Quản lí danh muc</a>
                    </li>
                    <li>
